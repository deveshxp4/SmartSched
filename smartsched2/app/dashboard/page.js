        ...
        <div className="flex flex-col h-full">
          <div className="p-6">
            ...
            <nav className="space-y-2">
              <a href="#" className="flex items-center space-x-3 px-4 py-3 rounded-lg bg-blue-500 text-white shadow-md">
                <PieChart size={20} />
                <span className="font-semibold">Dashboard</span>
              </a>

              <Link href="/my-timetable" className={`flex items-center space-x-3 px-4 py-3 rounded-lg text-gray-700 hover:bg-gray-100 transition-all ${!timetable && 'opacity-50 pointer-events-none'}`}>
                <Calendar size={20} />
                <span className="font-medium">My Timetable</span>
              </Link>

              <Link href="/daily-timetable" className={`flex items-center space-x-3 px-4 py-3 rounded-lg text-gray-700 hover:bg-gray-100 transition-all ${!timetable && 'opacity-50 pointer-events-none'}`}>
                <CheckSquare size={20} />
